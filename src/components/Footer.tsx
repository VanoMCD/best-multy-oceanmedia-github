...
const Footer = () => {
  ...
  const descriptionTextSize = getDescriptionTextSize();
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-stretch gap-8 mb-8">
            ...
            <div className="flex flex-col space-y-4 max-w-md">
              ...
              <p className={`text-primary-foreground/80 ${descriptionTextSize} ${descriptionLeading} flex-1 text-justify`}>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className={`${contactSpacing} text-sm text-primary-foreground/80 flex-1`}>
                <div>📧 {t('footer.email')}: <a href={`mailto:${t('footer.contactEmail')}`} className="hover:text-white hover:underline transition-colors">{t('footer.contactEmail')}</a></div>
